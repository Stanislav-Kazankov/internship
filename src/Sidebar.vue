<template>
  <div class="sidebar" :class="{'sidebar--extended': sidebarIsExtended, 'sidebar--open': sidebarIsOpen}">
    <button type="button" class="sidebar__toggle" @click="sidebarIsOpen = !sidebarIsOpen">
    ...
    <ul class="sidebar__menu sidebar__menu--user">
      ...
      <app-menu-item @activeMenuItemChanged="onActiveMenuItemChange" :activeMenuItem="activeMenuItem" :submenuItemNames="submenus.notifications" :sidebarIsExtended="sidebarIsExtended">
    ...
    <ul class="sidebar__menu sidebar__menu--additional">
      <app-menu-item @activeMenuItemChanged="onActiveMenuItemChange" :activeMenuItem="activeMenuItem" :submenuItemNames="submenus.settings" :sidebarIsExtended="sidebarIsExtended">
        <svg class="sidebar__menu-item-svg" slot="menuItemSvg" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <app-menu-item @activeMenuItemChanged="onActiveMenuItemChange" :activeMenuItem="activeMenuItem" :submenuItemNames="submenus.support" :sidebarIsExtended="sidebarIsExtended">
